...
> The project can run on any online Compiler(Note : Given Name of the File as Class Name)or offline Integrated Development Environment (IDE) like Eclipse, Netbeans, ideone.com, etc.
